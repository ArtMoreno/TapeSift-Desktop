"""A simple wrapping flow layout (based on the Qt FlowLayout example).

Lays child widgets left-to-right, wrapping to the next row when out of width.
Used for the tag-chip cloud on the Library Search screen.
"""
